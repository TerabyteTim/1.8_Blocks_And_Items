...
public class BlockIronTrapDoor extends Block {
    private static final String name = "iron_trapdoor";
    ...
    public void setBlockBoundsForItemRender() {
        float f = 0.1875F;
        this.setBlockBounds(0.0F, 0.5F - f / 2.0F, 0.0F, 1.0F, 0.5F + f / 2.0F,
                1.0F);
    }
    ...
    public void func_150120_a(World p_150120_1_, int p_150120_2_,
        ...
        int l = p_150120_1_.getBlockMetadata(p_150120_2_, p_150120_3_,
                p_150120_4_);
        boolean flag1 = (l & 4) > 0;

        if (flag1 != p_150120_5_) {
            p_150120_1_.setBlockMetadataWithNotify(p_150120_2_, p_150120_3_,
                    p_150120_4_, l ^ 4, 2);
    ...
    public void onNeighborBlockChange(World p_149695_1_, int p_149695_2_,
        ...
        if (!p_149695_1_.isRemote) {
            ...
            if (!(func_150119_a(p_149695_1_.getBlock(i1, p_149695_3_, j1)) || p_149695_1_
                    .isSideSolid(i1, p_149695_3_, j1,
                            ForgeDirection.getOrientation((l & 3) + 2)))) {
                p_149695_1_
            ...
            boolean flag = p_149695_1_.isBlockIndirectlyGettingPowered(
    ...
    public boolean canPlaceBlockOnSide(World p_149707_1_, int p_149707_2_,
        ...
        if (p_149707_5_ == 0) {
            ...
            return func_150119_a(p_149707_1_.getBlock(p_149707_2_, p_149707_3_,
                    p_149707_4_))
                    || p_149707_1_.isSideSolid(p_149707_2_, p_149707_3_,
                            p_149707_4_, ForgeDirection.UP);
        }
    }
    ...
    private static boolean func_150119_a(Block p_150119_0_) {
        if (disableValidation) {
            ...
            return p_150119_0_.getMaterial().isOpaque()
