...
public class BlockDoor extends Block
{
    ...
    public BlockDoor(Material p_i45402_1_, Item blockItem, String name)
    {
        super(p_i45402_1_);
    ...
    public void registerBlockIcons(IIconRegister iiconregister)
    {
        ...
        this.field_150017_a[0] = iiconregister.registerIcon(this.getTextureName() + "_upper");
        this.field_150016_b[0] = iiconregister.registerIcon(this.getTextureName() + "_lower");
