...
public class BlockFenceGate extends net.minecraft.block.BlockFenceGate
{
    ...
    public BlockFenceGate(String name, int plankType)
    {
        super();
        this.setCreativeTab(CreativeTabs.tabRedstone);
        
        GameRegistry.registerBlock(this, "fence_gate_" + name);

        this.setBlockName("fence_gate_" + name);
        this.setHardness(2);
    ...
    {
        return Blocks.planks.getIcon(p_149691_1_, plankType);
    }
